...
from network.basic_block_moco import ResNetFCNMoco
from network.xModalKD_moco import xModalKD
...
if __name__ == '__main__':
    ...
    if not configs['test']:
        ...
        os.system('cp main_3d2d_moco_fov.py {}'.format(backup_dir))
        ...
        os.system('cp network/basic_block_moco.py {}'.format(backup_dir))
        os.system('cp network/xModalKD_moco.py {}'.format(backup_dir))
