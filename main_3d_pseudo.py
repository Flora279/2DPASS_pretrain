...
from dataloader.pc_dataset_3d_pseudo import get_pc_model_class
...
if __name__ == '__main__':
    ...
    if not configs['test']:
        ...
        os.system('cp main_3d_pseudo.py {}'.format(backup_dir))
        os.system('cp dataloader/dataset_3d.py {}'.format(backup_dir))
        os.system('cp dataloader/pc_dataset_3d_pseudo.py {}'.format(backup_dir))
