...
class SemanticKITTI_90fov_plabel(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        path = '/storage/data/wudj/dataset/SemanticKITTI/kitti/data/sequences/mapped_points/{0}_{1}_mapped_pts.npy'.format(seq, scan)
        mask_path = '/storage/data/wudj/dataset/SemanticKITTI/kitti/data/sequences/mapped_points/{0}_{1}_mask.npy'.format(seq, scan)
        ...
        intern_pred_path = '/storage/data/wudj/dataset/SemanticKITTI/kitti/data/sequences/{0}/image_2_pred_new/{1}.png'.format(
            seq, scan.split('.')[0])
...
class SemanticKITTI_90fov_plabel_high_conf(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        intern_pred_path = '/storage/data/wudj/dataset/SemanticKITTI/kitti/data/sequences/{0}/image_2_pred_new/{1}.png'.format(
            seq, scan.split('.')[0])
        intern_pred = cv2.imread(intern_pred_path, cv2.IMREAD_GRAYSCALE)  # get prediction in cityscapes label id: 0~18
        confidence_path = '/storage/data/wudj/dataset/SemanticKITTI/kitti/data/sequences/{0}/image_2_pred_new_maxprob/{1}.png'.format(
            seq, scan.split('.')[0])
        ...
        common_pixels_pred[conf_90fov <= 2] = 0
