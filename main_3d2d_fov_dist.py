...
from dataloader.pc_dataset_dist import get_pc_model_class as get_pc_model_class_3d2d
...
if __name__ == '__main__':
    ...
    if not configs['test']:
        ...
        os.system('cp main_3d2d_fov_dist.py {}'.format(backup_dir))
        ...
        os.system('cp dataloader/pc_dataset_dist.py {}'.format(backup_dir))
