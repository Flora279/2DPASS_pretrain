...
from network.spvcnn_teacher_prototype import get_model as SPVCNN
from network.spvcnn_teacher_prototype import criterion, PartialConsistencyLoss
...
class FusionDistTrainer(pl.LightningModule):
    def __init__(self, config):
        ...
        self.embedding_size = self.hiden_size * self.num_scales #128*4-> 256         
        ...
        self.register_buffer('prototype', F.normalize(torch.rand(self.num_classes-1, self.embedding_size), p=2, dim=1) )# car, ground ,wall
    ...
    def training_step(self, data_dict, batch_idx):
        ...
        student_loss, step_embedding = self.student_criterion(student_dict, self.prototype)
...
if __name__ == '__main__':
    ...
    if not configs['test']:
        ...
        os.system('cp main_3d2d_teacher_prototype_fov.py {}'.format(backup_dir))
        ...
        os.system('cp network/spvcnn_teacher_prototype.py {}'.format(backup_dir))
