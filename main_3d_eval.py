...
class Backbone3DTrainer(pl.LightningModule):
    def __init__(self, config):
        ...
        print("self.train_config['data_path']", self.train_config['data_path'])
        ...
        print('len of train dataset', len(self.train_pt_dataset))
        print('len of val dataset', len(self.val_pt_dataset))
        if self.gpu_num > 1:
...
if __name__ == '__main__':
    ...
    # setting
    path = '/public/home/zhangjy/weaksup/2DPASS/ckpt/epoch=83-step=40152-val_miou=62.369.ckpt'
    ...
    my_model = Backbone3DTrainer.load_from_checkpoint(path, config=configs)
